...
//   isActive    — boolean
// ─────────────────────────────────────────────────────────────────────────────
export function RegisterForm({ rf, upRf, role, setRole, showP, showP2, setShowP, setShowP2, loading, error, success, onSubmit, onSwitch, direction, tab }) {
  return (
    <div style={{
      ...
      <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column" }}>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "#94a3b8", marginTop: 11 }}>
          Already registered? <span className="link-text" onClick={onSwitch}>Sign in →</span>
        </p>
      </form>
    </div>
  );
