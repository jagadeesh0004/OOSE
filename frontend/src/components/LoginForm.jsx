...
//   tab      — "login" | "register"
// ─────────────────────────────────────────────────────────────────────────────
export function LoginForm({ lf, upLf, loading, showP, setShowP, onSubmit, onSwitch, direction, tab, error, success }) {
      ...
      <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ position: "relative" }}>
            ...
            <button type="button" className="eye-btn" onClick={() => setShowP((p) => !p)}><EyeIcon open={showP} /></button>
          </div>
        </div>
