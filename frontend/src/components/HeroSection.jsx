      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", width: "100%", display: "flex", alignItems: "center", gap: 80 }}>
        ...
        <div style={{ flex: 1, position: "relative", zIndex: 1 }}>
          ...
          <div className={`fade-in ${visible ? "visible" : ""}`} style={{ display: "flex", gap: 14, flexWrap: "wrap", transitionDelay: "0.3s" }}>
            <button type="button" className="cta-primary" onClick={(e) => { e.preventDefault(); onGetStarted(); }}>Start Free — As Patient</button>
            <button type="button" className="cta-ghost" onClick={(e) => { e.preventDefault(); onJoinAsDoctor(); }}>Join as Doctor →</button>
          </div>
