...
import { PatientSidebar, PatientTopbar } from "../components/layout/PatientLayout";
...
// Import patient page modules
import { PatientOverview } from "../modules/patient/pages/Overview";
import { PatientMyAppointments } from "../modules/patient/pages/MyAppointments";
import { PatientBookAppointment } from "../modules/patient/pages/BookAppointment";
import { PatientPrediction } from "../modules/patient/pages/Prediction";
import { PatientPredictionHistory } from "../modules/patient/pages/PredictionHistory";
...
═══════════════════════════════════════════════════════════════════════ */
const PAGES = {
  overview: { label: "Overview", component: PatientOverview },
  appointments: { label: "My Appointments", component: PatientMyAppointments },
  book: { label: "Book Appointment", component: PatientBookAppointment },
  predict: { label: "Health Check", component: PatientPrediction },
  history: { label: "Prediction History", component: PatientPredictionHistory },
  profile: { label: "Profile", component: PatientProfile },
};
    ...
    return (
      <div style={{ minHeight: "100vh", background: BG, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          <p style={{ fontSize: 14, color: "#64748b", marginTop: 10, lineHeight: 1.6 }}>
            This dashboard is for patient accounts only.
          </p>
        </div>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Topbar */}
        <PatientTopbar page={currentPage} user={user} onLogout={logout} />
