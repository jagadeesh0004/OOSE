  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", gap: 10 }}>
        <button className="cta-ghost" style={{ padding: "9px 22px", fontSize: 14 }} onClick={onLogin}>Sign In</button>
        <button className="cta-primary" style={{ padding: "9px 22px", fontSize: 14 }} onClick={onGetStarted}>Get Started</button>
      </div>
    </nav>
  );
}
